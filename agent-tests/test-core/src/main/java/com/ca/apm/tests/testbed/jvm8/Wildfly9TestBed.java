 ...
 */
@TestBedDefinition
public class Wildfly9TestBed extends AgentRegressionBaseTestBed {

    private static final String WILDFLY_INSTALL_HOME = DEPLOY_BASE + "wildfly-9.0.0.Final/";
    public static final String WILDFLY_ROLE_ID       = "wildfly9";
    ...
    protected void initSystemProperties(ITasResolver tasResolver, 
        ...
        initJbossSystemProperties(host, home, "9", props, javaRole.getInstallDir());     
    ...
    protected ITestbedMachine initMachine(ITasResolver tasResolver) {
        ...
        GenericRole wildflyRole = new GenericRole.Builder(WILDFLY_ROLE_ID, tasResolver)
            .unpack(new DefaultArtifact("com.ca.apm.binaries", "wildfly", "zip", "9.0.0.Final"),  
        ...
        String jvmArgs = "-Djava.util.logging.manager=org.jboss.logmanager.LogManager -Djboss.modules.system.pkgs=org.jboss.logmanager," +     
            ...
            "-Xbootclasspath/p:" + codifyPath(WILDFLY_INSTALL_HOME) + "/modules/system/layers/base/org/jboss/logmanager/main/jboss-logmanager-2.0.0.Final.jar;" +
            codifyPath(WILDFLY_INSTALL_HOME) + "/modules/system/layers/base/org/jboss/log4j/logmanager/main/log4j-jboss-logmanager-1.1.2.Final.jar";
