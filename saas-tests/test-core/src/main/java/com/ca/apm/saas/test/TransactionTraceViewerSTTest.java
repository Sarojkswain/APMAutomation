...
import com.ca.apm.saas.test.atc.UITest;
import com.ca.apm.saas.test.helpers.ErrorReport;
import com.ca.apm.saas.standalone.FLDStandAloneTestbed;
...
import static com.ca.apm.saas.test.utils.Common.matchRegExAndLog;
...
public class TransactionTraceViewerSTTest extends UITest {
    ...
    @Tas(testBeds = @TestBed(name = FLDStandAloneTestbed.class,
        executeOn = FLDStandAloneTestbed.EM_MACHINE_ID), size = SizeType.BIG, owner = "ahmal01")
    @Parameters({"browserType"})
    @Test(groups = {"ttviewer_ui"}, threadPoolSize = 5, invocationCount = 5)
        ...
        try {
           ...
           new Actions(ui.getDriver())
            ...
            WebElement transactionTracePanel = Utils.waitForCondition(ui.getDriver(),
              ExpectedConditions.presenceOfElementLocated(By.xpath("//*[contains(@id, 'gridTransactionTraces')]")));
            PageElement transactionTracesLink = wrapElement(transactionTracePanel.findElement(
              By.xpath("//*[contains(@class, 'ui-grid-row')]")), ui);
...
//                ui.getDriver(), By.xpath("//*[contains(@class, 'ui-grid-cell')]"));
//            WebElement bottomDrawerHeader
//                = bottomDrawer.findElement(By.xpath("//*[contains(@id, 'ui-grid-cell')]"));
//            ui-grid-cell-contents ng-scope   
            
//            final String boxName2 = "pipeorgan";
//            verifyTransactionTracesTable(ui, boxName2, bottomDrawerContent, bottomDrawerHeader);
