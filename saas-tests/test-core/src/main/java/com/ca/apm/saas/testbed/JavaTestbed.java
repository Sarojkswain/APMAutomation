...
import com.ca.apm.saas.role.JavaRole;

import static com.ca.tas.testbed.ITestbedMachine.TEMPLATE_CO_LATEST;
...
public class JavaTestbed implements ITestbedFactory {
    ...
    public static final String JAVA_MACHINE_TEMPLATE_ID = TEMPLATE_CO_LATEST;
    ...
    public ITestbed create(ITasResolver tasResolver) {
        ...
        IRole java8Role = new JavaRole.LinuxBuilder(JAVA8_ROLE_ID, tasResolver)
            .dir(JAVA_HOME)
            .version(JavaBinary.LINUX_64BIT_JRE_18)
            .build();

        ITestbedMachine javaMachine = new TestbedMachine.LinuxBuilder(JAVA_MACHINE_ID).templateId(JAVA_MACHINE_TEMPLATE_ID).build();
