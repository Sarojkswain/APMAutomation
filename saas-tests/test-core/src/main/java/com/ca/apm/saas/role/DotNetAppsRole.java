 ...
 * @author kurma05
 */
public class DotNetAppsRole extends AbstractRole {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(DotNetAppsRole.class);

    protected DotNetAppsRole(Builder builder) {
    ...
    public static class Builder extends BuilderBase<Builder, DotNetAppsRole> {
        ...
        @Override
        public DotNetAppsRole build() {
            return getInstance();
        }

        @Override
        protected DotNetAppsRole getInstance() {
            return new DotNetAppsRole(this);
        }
