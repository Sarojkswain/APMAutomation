 ...
 *
 */
public class FLDJbossLoadProvider implements FLDStandAloneConstants, FldTestbedProvider {
    ...
    private void addJboss7(ITestbed testbed, ITasResolver tasResolver) {
        ...
        AgentRole agentRole = new AgentRole.Builder(JBOSS7_ROLE_ID + "-agent", tasResolver)
            ...
            .build();
        JMeterRole jmeter = new JMeterRole.Builder(JMETER_LOAD5, tasResolver).jmxFile("jboss_fld_JBoss7_8080.jmx").build();
        machine.addRole(javaRole, webAppRole, jbossRole, agentRole,jmeter);
    }
    ...
    private void addJboss6(ITestbed testbed, ITasResolver tasResolver) {
        ...
        AgentRole agentRole = new AgentRole.Builder(JBOSS6_ROLE_ID + "-agent", tasResolver)
            ...
            .additionalProperties(additionalProperties)
            .build();
        JMeterRole jmeter = new JMeterRole.Builder(JMETER_LOAD6, tasResolver).installJmeter(true).jmxFile("jboss_fld_JBoss6_8180.jmx").build();
        machine.addRole(javaRole, webAppRole, jbossRole, agentRole,jmeter);
    }
