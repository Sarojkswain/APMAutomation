 ...
 *
 */
public class FLDWebSphereLoadProvider implements FLDStandAloneConstants, FldTestbedProvider {
    ...
    private void initWas01(ITestbed testbed, ITasResolver tasResolver) {
        ...
        ClientDeployRole client1 = new ClientDeployRole.Builder(LOAD1_ROLE_ID,
            tasResolver).emHost(emHost).build();
        JMeterRole jmeter = new JMeterRole.Builder(JMETER_LOAD7, tasResolver).jmxFile("WAS_fld_WAS_BRTTestApp.jmx").build();

        was01Machine.addRole(brtmTestAppRole, was85Role, agentRole, client1,jmeter);
    }
    ...
    private void initWas02(ITestbed testbed, ITasResolver tasResolver) {
        ...
        ClientDeployRole clientRole =
            new ClientDeployRole.Builder(WAS_XCLUSTER_CLIENT_ROLE_ID, tasResolver)
               .emHost(emHost)
