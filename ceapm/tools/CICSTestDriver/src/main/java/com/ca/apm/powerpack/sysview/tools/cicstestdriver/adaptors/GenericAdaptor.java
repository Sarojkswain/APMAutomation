...
{
	private static final Logger LOGGER = Logger.getLogger(GenericAdaptor.class);
	protected static String[] arguments = null;
	protected static CallJobStack callJobStack = null;

    public boolean initialize(CallJobStack inCallJobStack){callJobStack = inCallJobStack; return true;};
