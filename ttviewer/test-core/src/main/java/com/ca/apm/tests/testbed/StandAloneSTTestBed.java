...
/**
 * Transaction trace viewer ST testbed.
 *
 * @author ahmal01
 */

@TestBedDefinition
public class StandAloneSTTestBed implements ITestbedFactory {

    public static final Logger log = LoggerFactory.getLogger(StandAloneSTTestBed.class);
    ...
    public ITestbed create(ITasResolver tasResolver) {
        ...
        ITestbedMachine saMasterMachine =
            TestBedUtils.createWindowsMachine(SA_MASTER, TEMPLATE_ID);
        ...
        ITestbedMachine tomcatAgentOnlyMachine =
            TestBedUtils.createWindowsMachine(TOMCAT_AGENT_ONLY, TEMPLATE_ID);
        ...
        ITestbedMachine wlsAgentOnlyMachine =
            TestBedUtils.createWindowsMachine(WLS_AGENT_ONLY, TEMPLATE_ID);
