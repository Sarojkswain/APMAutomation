...
import com.ca.apm.automation.action.flow.utility.ReplaceFilter;
...
public class FileCreatorFlow extends FlowBase {

    private static final Logger LOGGER = LoggerFactory.getLogger(com.ca.apm.automation.action.flow.utility.FileCreatorFlow.class);
