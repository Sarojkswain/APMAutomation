/*
 * AgentControllability1Collector1TomcatAgentTestbed * Copyright (c) 2014 CA. All rights reserved.
 * 
...
@TestBedDefinition
public class HTTPTunnellingClusterWindowsTestbed implements ITestbedFactory {
    ...
    public ITestbed create(ITasResolver tasResolver) {
        ...
        ApacheRole apacheRole =
            new ApacheRole.LinuxBuilder(AgentControllabilityConstants.APACHE_ROLE_ID).build();
