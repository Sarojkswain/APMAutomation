...
@TestBedDefinition
public class AgentEMFailoverWindowsStandAloneTestbed implements ITestbedFactory {
    ...
    public ITestbed create(ITasResolver tasResolver) {
        ...
        TestbedMachine emMachine =
            TestBedUtils.createWindowsMachine(EM_MACHINE_ID, EM_TEMPLATE_ID, emRole);
        
        TestbedMachine freeMachine =
            TestBedUtils.createWindowsMachine(freeMachineID, EM_TEMPLATE_ID, new DeployFreeRole(freeRole_ID) );
