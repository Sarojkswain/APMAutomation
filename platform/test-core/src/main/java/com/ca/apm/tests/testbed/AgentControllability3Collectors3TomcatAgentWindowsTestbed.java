 ...
 */
@TestBedDefinition
public class AgentControllability3Collectors3TomcatAgentWindowsTestbed implements ITestbedFactory {
    ...
    public ITestbed create(ITasResolver tasResolver) {
        ...
        EmRole collector2Role =
            new EmRole.Builder(AgentControllabilityConstants.COLLECTOR2_ROLE_ID, tasResolver)
                .emClusterRole(DeployEMFlowContext.EmRoleEnum.COLLECTOR)
                .silentInstallChosenFeatures(collectorChosenFeatures)
                .dbhost(tasResolver.getHostnameById(AgentControllabilityConstants.MOM_ROLE_ID))
                .nostartEM().nostartWV().build();
        ...
        EmRole collector3Role =
            new EmRole.Builder(AgentControllabilityConstants.COLLECTOR3_ROLE_ID, tasResolver)
                .emClusterRole(DeployEMFlowContext.EmRoleEnum.COLLECTOR)
                .silentInstallChosenFeatures(collectorChosenFeatures)
                .dbhost(tasResolver.getHostnameById(AgentControllabilityConstants.MOM_ROLE_ID))
                .nostartEM().nostartWV().build();
        ...
        TomcatRole tomcatRole1 =
            new TomcatRole.Builder(AgentControllabilityConstants.TOMCAT_ROLE1_ID, tasResolver)
        ...
        IRole tomcatAgentRole1 =
            new AgentRole.Builder(AgentControllabilityConstants.TOMCAT_AGENT1_ROLE_ID, tasResolver)
                .webAppServer(tomcatRole1).customName("Tomcat1")
                .intrumentationLevel(AgentInstrumentationLevel.FULL).emRole(momRole).build();


        TomcatRole tomcatRole2 =
            new TomcatRole.Builder(AgentControllabilityConstants.TOMCAT_ROLE2_ID, tasResolver)
        ...
        IRole tomcatAgentRole2 =
            new AgentRole.Builder(AgentControllabilityConstants.TOMCAT_AGENT2_ROLE_ID, tasResolver)
                .webAppServer(tomcatRole2).customName("Tomcat2")
                .intrumentationLevel(AgentInstrumentationLevel.FULL).emRole(momRole).build();


        TomcatRole tomcatRole3 =
            new TomcatRole.Builder(AgentControllabilityConstants.TOMCAT_ROLE3_ID, tasResolver)
        ...
        IRole tomcatAgentRole3 =
            new AgentRole.Builder(AgentControllabilityConstants.TOMCAT_AGENT3_ROLE_ID, tasResolver)
                .webAppServer(tomcatRole3).customName("Tomcat3")
                .intrumentationLevel(AgentInstrumentationLevel.FULL).emRole(momRole).build();
        ...
        ITestbedMachine collector2Machine =
            TestBedUtils.createWindowsMachine(AgentControllabilityConstants.COLLECTOR2_MACHINE_ID,
                AgentControllabilityConstants.WINDOWS_TEMPLATE_ID);
        ITestbedMachine collector3Machine =
            TestBedUtils.createWindowsMachine(AgentControllabilityConstants.COLLECTOR3_MACHINE_ID,
                AgentControllabilityConstants.WINDOWS_TEMPLATE_ID);
        ...
        ITestbedMachine tomcatMachine1 =
            TestBedUtils.createWindowsMachine(AgentControllabilityConstants.TOMCAT_MACHINE_ID1,
                AgentControllabilityConstants.WINDOWS_TEMPLATE_ID);
        ITestbedMachine tomcatMachine2 =
            TestBedUtils.createWindowsMachine(AgentControllabilityConstants.TOMCAT_MACHINE_ID2,
                AgentControllabilityConstants.WINDOWS_TEMPLATE_ID);
        ITestbedMachine tomcatMachine3 =
            TestBedUtils.createWindowsMachine(AgentControllabilityConstants.TOMCAT_MACHINE_ID3,
                AgentControllabilityConstants.WINDOWS_TEMPLATE_ID);
