...
@TestBedDefinition
public class CDVOneClusterOneTomcatWindowsTestbed implements ITestbedFactory {
   ...
   protected final String EM_TEMPLATE_ID = CDVConstants.EM_TEMPLATE_ID_WIN;

   protected final String AGENT_MACHINE_ID = CDVConstants.AGENT_MACHINE_ID;
   protected final String AGENT_MACHINE_TEMPLATE_ID = CDVConstants.AGENT_MACHINE_TEMPLATE_ID_WIN;
    ...
    public ITestbed create(ITasResolver tasResolver) {
        ...
        EmRole collector1Role =
            new EmRole.Builder(COLLECTOR1_ROLE_ID, tasResolver)
                ...
                .installDir(TasBuilder.WIN_SOFTWARE_LOC+"em_col")
        ...
        TestbedMachine emMachine =
            TestBedUtils
                .createWindowsMachine(EM_MACHINE_ID, EM_TEMPLATE_ID, momRole, collector1Role);
