...
@TestBedDefinition
public class DBMigrationLinuxTestbed implements ITestbedFactory {
    ...
    public static final String EM_TEMPLATE_ID = TEMPLATE_CO65; 
    ...
    public ITestbed create(ITasResolver tasResolver) {
      ...
      //creates Generic roles to download artifacts
        ...
        TestbedMachine emMachine =
            TestBedUtils
                .createLinuxMachine(EM_MACHINE_ID, EM_TEMPLATE_ID, emRole, downloadDbBackupRole); 
        
        // Configuration of em oracle machine
        TestbedMachine emMachine_orcl =
            TestBedUtils
                .createLinuxMachine(EM_MACHINE_ORCL_ID, EM_TEMPLATE_ID, emRoleOrcl);
