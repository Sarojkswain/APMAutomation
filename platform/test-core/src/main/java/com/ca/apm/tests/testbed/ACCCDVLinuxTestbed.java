...
@TestBedDefinition
public class ACCCDVLinuxTestbed implements ITestbedFactory {
   ...
   public static final String EM_TEMPLATE_ID = CDVConstants.EM_TEMPLATE_ID_LINUX;

   public static final String AGENT_MACHINE_ID = CDVConstants.AGENT_MACHINE_ID;
   public static final String AGENT_MACHINE_TEMPLATE_ID = CDVConstants.AGENT_MACHINE_TEMPLATE_ID_LINUX;
   ...
   public static final String QA_APP_JBOSS_ROLE_ID = CDVConstants.QA_APP_JBOSS_ROLE_ID;
    ...
    public ITestbed create(ITasResolver tasResolver) {
        ...
        // Mom1Collector2 role
        EmRole mom1Col2Role =
            new EmRole.LinuxBuilder(MOM1_COL2_ROLE_ID, tasResolver)
                .emClusterRole(DeployEMFlowContext.EmRoleEnum.COLLECTOR)
                .silentInstallChosenFeatures(emChosenFeatures)
                .dbhost(tasResolver.getHostnameById(MOM1_ROLE_ID))
                .installDir(TasBuilder.LINUX_SOFTWARE_LOC+"em_col2")
        ...
        // Mom2Collector2 role
        EmRole mom2Col2Role =
            new EmRole.LinuxBuilder(MOM2_COL2_ROLE_ID, tasResolver)
                .emClusterRole(DeployEMFlowContext.EmRoleEnum.COLLECTOR)
                .silentInstallChosenFeatures(emChosenFeatures)
                .dbhost(tasResolver.getHostnameById(MOM2_ROLE_ID))
                .installDir(TasBuilder.LINUX_SOFTWARE_LOC+"em_col2")
        ...
        TestbedMachine mom1Machine =
            TestBedUtils
                .createLinuxMachine(MOM1_MACHINE_ID, EM_TEMPLATE_ID, mom1Role, mom1Col1Role, mom1Col2Role);
        // Configuration of mom2 machine
        TestbedMachine mom2Machine =
            TestBedUtils
                .createLinuxMachine(MOM2_MACHINE_ID, EM_TEMPLATE_ID, mom2Role, mom2Col1Role, mom2Col2Role);
