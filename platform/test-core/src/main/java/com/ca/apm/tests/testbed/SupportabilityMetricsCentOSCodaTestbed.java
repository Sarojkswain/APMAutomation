 ...
 */
@TestBedDefinition
public class SupportabilityMetricsCentOSCodaTestbed extends CodaTestBed {
	
	public static final String JAVA8_ROLE_ID = "java8Role";
    public static final String JAVA_HOME = "/opt/automattion/deployed";
    ...
    public ITestbed create(ITasResolver tasResolver) {
        ...
        TestbedMachine TestMachine = new TestbedMachine.LinuxBuilder("TestMachine").templateId(TEMPLATE_CO66).build();
...
//        c1Role.addProperty("install.parent.dir", " C:/sw");
        ...
        c1Role.addProperty("Base_dir", "/root/sw");
        ...
        c1Role.addProperty("testng.xml", "/root/sw/testng/testng.xml");
