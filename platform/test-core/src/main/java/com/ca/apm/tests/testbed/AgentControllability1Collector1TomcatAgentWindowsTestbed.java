...
@TestBedDefinition
public class AgentControllability1Collector1TomcatAgentWindowsTestbed implements ITestbedFactory {
    ...
    public ITestbed create(ITasResolver tasResolver) {
        ...
        agentMachine.addRemoteResource(RemoteResource.createFromRegExp(".*_(\\d+)", tomcatRole.getTomcatFlowContext().getTomcatInstallDir()+ "\\wily\\core\\config"));
