 ...
 */
@TestBedDefinition
public class ACCHTTPS3CollectorsClusterTestbed implements ITestbedFactory {
    ...
    public ITestbed create(ITasResolver tasResolver) {
        ...
        EmRole collector1Role =
            new EmRole.LinuxBuilder(AgentControllabilityConstants.COLLECTOR1_ROLE_ID, tasResolver)
                ...
                .installDir("/opt/automation/deployed/collector1")
        ...
        EmRole collector2Role =
            new EmRole.LinuxBuilder(AgentControllabilityConstants.COLLECTOR2_ROLE_ID, tasResolver)
                .emClusterRole(DeployEMFlowContext.EmRoleEnum.COLLECTOR)
                .installDir("/opt/automation/deployed/collector2")
                .silentInstallChosenFeatures(collectorChosenFeatures)
                .dbhost(tasResolver.getHostnameById(AgentControllabilityConstants.MOM_ROLE_ID)).nostartEM()
                .nostartWV().build();
        ...
        EmRole collector3Role =
            new EmRole.LinuxBuilder(AgentControllabilityConstants.COLLECTOR3_ROLE_ID, tasResolver)
                .emClusterRole(DeployEMFlowContext.EmRoleEnum.COLLECTOR)
                .installDir("/opt/automation/deployed/collector3")
                .silentInstallChosenFeatures(collectorChosenFeatures)
                .dbhost(tasResolver.getHostnameById(AgentControllabilityConstants.MOM_ROLE_ID)).nostartEM()
                .nostartWV().build();
        ...
        WebAppRole<TomcatRole> qaAppTomcatRole1 =
            new QaAppTomcatRole.Builder(AgentControllabilityConstants.QA_APP_TOMCAT_ROLE1_ID, tasResolver)
                .cargoDeploy().contextName("qa-app").build();

        WebAppRole<TomcatRole> qaAppTomcatRole2 =
            new QaAppTomcatRole.Builder(AgentControllabilityConstants.QA_APP_TOMCAT_ROLE2_ID, tasResolver)
                .cargoDeploy().contextName("qa-app").build();

        WebAppRole<TomcatRole> qaAppTomcatRole3 =
            new QaAppTomcatRole.Builder(AgentControllabilityConstants.QA_APP_TOMCAT_ROLE3_ID, tasResolver)
                .cargoDeploy().contextName("qa-app").build();
        ...
        IRole tomcatAgentRole1 =
            new AgentRole.LinuxBuilder(AgentControllabilityConstants.TOMCAT_AGENT1_ROLE_ID, tasResolver)
                .webAppRole(tomcatRole1).customName("Tomcat1")
        ...
        IRole tomcatAgentRole2 =
            new AgentRole.LinuxBuilder(AgentControllabilityConstants.TOMCAT_AGENT2_ROLE_ID, tasResolver)
                .webAppRole(tomcatRole2).customName("Tomcat2")
                .intrumentationLevel(AgentInstrumentationLevel.FULL)
                .emRole(momRole).build();
        ...
        IRole tomcatAgentRole3 =
            new AgentRole.LinuxBuilder(AgentControllabilityConstants.TOMCAT_AGENT3_ROLE_ID, tasResolver)
                .webAppRole(tomcatRole3).customName("Tomcat3")
                .intrumentationLevel(AgentInstrumentationLevel.FULL)
                .emRole(momRole).build();
        ...
        ITestbedMachine momMachine =
            TestBedUtils.createLinuxMachine(AgentControllabilityConstants.MOM_MACHINE_ID,
                AgentControllabilityConstants.RH66_TEMPLATE_ID);
