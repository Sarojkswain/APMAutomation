 ...
 * in Windows for execution of all JavaScriptCalculatorsStandalone test cases. *
 */
@TestBedDefinition
public class JavaScriptCalculatorsStandaloneLinuxTestbed implements ITestbedFactory {
    ...
    public ITestbed create(ITasResolver tasResolver) {
        ...
        // create EM role
        EmRole emRole =
            new EmRole.LinuxBuilder(AgentControllabilityConstants.EM_ROLE_ID, tasResolver)
        ...
        IRole tomcatAgentRole =
            new AgentRole.LinuxBuilder(AgentControllabilityConstants.TOMCAT_AGENT_ROLE_ID,
                ...
                .intrumentationLevel(AgentInstrumentationLevel.FULL).emRole(emRole).build();
        ...
        emMachine.addRole(emRole, downloadJavaScriptFilesRole);
        ...
        emMachine.addRemoteResource(RemoteResource.createFromRegExp(".*", emRole
