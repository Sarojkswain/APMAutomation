...
@TestBedDefinition
public class AgentControllability3Collectors1TomcatAgentWindowsTestbed implements ITestbedFactory {
    ...
    public ITestbed create(ITasResolver tasResolver) {
        ...
        TestbedMachine collector2Machine =
            TestBedUtils.createWindowsMachine(AgentControllabilityConstants.COLLECTOR2_MACHINE_ID,
                AgentControllabilityConstants.WINDOWS_TEMPLATE_ID, collector2Role);

        TestbedMachine collector3Machine =
            TestBedUtils.createWindowsMachine(AgentControllabilityConstants.COLLECTOR3_MACHINE_ID,
                AgentControllabilityConstants.WINDOWS_TEMPLATE_ID, collector3Role);
        ...
        TestbedMachine agentMachine =
            TestBedUtils.createWindowsMachine(AgentControllabilityConstants.TOMCAT_MACHINE_ID,
                AgentControllabilityConstants.WINDOWS_TEMPLATE_ID, tomcatRole, qaAppTomcatRole, tomcatAgentRole);
