 ...
 * This is on Windows and to serve as Common Testbed for APM Testing *
 */

@TestBedDefinition
public class TwoCollectorsOneTomcatOneJBossWindowsTestbed implements ITestbedFactory {
    ...
    public ITestbed create(ITasResolver tasResolver) {
        ...
        IRole tomcatAgentRole =
            new AgentRole.Builder(TOMCAT_AGENT_ROLE_ID, tasResolver)
        ...
        TestbedMachine collector1Machine =
            TestBedUtils.createWindowsMachine(COLLECTOR1_MACHINE_ID,
                WINDOWS_TEMPLATE_ID, collector1Role, tomcatRole, tomcatAgentRole, qaAppTomcatRole);

        // Configuration of Collector2 and JBoss machine
        TestbedMachine collector2Machine =
            TestBedUtils.createWindowsMachine(COLLECTOR2_MACHINE_ID,
                WINDOWS_TEMPLATE_ID, collector2Role, jbossRole, jbossAgentRole, qaAppJbossRole);
        
        // Configuration of mom machine
        TestbedMachine momMachine =
            TestBedUtils.createWindowsMachine(MOM_MACHINE_ID,
                WINDOWS_TEMPLATE_ID, momRole);
