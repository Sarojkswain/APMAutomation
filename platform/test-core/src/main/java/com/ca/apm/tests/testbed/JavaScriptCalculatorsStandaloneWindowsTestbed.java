 ...
 */
@TestBedDefinition
public class JavaScriptCalculatorsStandaloneWindowsTestbed implements ITestbedFactory {
    ...
    public ITestbed create(ITasResolver tasResolver) {
        ...
        // create EM role
        EmRole emRole =
            new EmRole.Builder(AgentControllabilityConstants.EM_ROLE_ID, tasResolver).nostartEM()
                .nostartWV().build();
