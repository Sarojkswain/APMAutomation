 ...
 * and 1 agent on Linux for execution of bpem test cases. *
 */

@TestBedDefinition
public class BPEMLinuxTestbed implements ITestbedFactory {
	...
	protected static String EM_TEMPLATE_ID = BPEMConstants.EM_TEMPLATE_ID_LINUX;	
	...
	public ITestbed create(ITasResolver tasResolver) {
		...
		TestbedMachine collector2Machine = TestBedUtils.createLinuxMachine(
				COLLECTOR2_MACHINE_ID, EM_TEMPLATE_ID, collector2Role, tomcatRole,
				qaAppTomcatRole, tomcatAgentRole);
