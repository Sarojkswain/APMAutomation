 ...
 * in Windows for execution of Windows Control Scripts test cases for GA EM. *
 * GAMSA03/Santosh Gampa
 * 4/20/2016
 */

@TestBedDefinition
public class EMControlScriptsWindowsTestbed implements ITestbedFactory {
