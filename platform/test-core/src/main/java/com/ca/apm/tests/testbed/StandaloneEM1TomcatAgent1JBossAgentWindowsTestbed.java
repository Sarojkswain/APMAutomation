 ...
 */
@TestBedDefinition
public class StandaloneEM1TomcatAgent1JBossAgentWindowsTestbed implements ITestbedFactory {
    ...
    public ITestbed create(ITasResolver tasResolver) {
        ...
        WebAppRole<JbossRole> qaAppJbossRole =
            new QaAppJbossRole.Builder(AgentControllabilityConstants.QA_APP_JBOSS_ROLE_ID, tasResolver)
     ...
     // Jboss Role
        JbossRole jbossRole =
            new JbossRole.Builder(AgentControllabilityConstants.JBOSS_ROLE_ID, tasResolver).version(JBossVersion.JBOSS711)
                .addWebAppRole(qaAppJbossRole).build();

        // Jboss Agent Role
        IRole jbossAgentRole =
            new AgentRole.Builder(AgentControllabilityConstants.JBOSS_AGENT_ROLE_ID, tasResolver).webAppServer(jbossRole)
