 ...
 */
@TestBedDefinition
public class StandaloneOnlyEMLinuxTestbed implements ITestbedFactory {
	...
	public static final String SAMPLE_APP_LOC = TasBuilder.LINUX_SOFTWARE_LOC
			+ "sampleApps/";
	...
	public ITestbed create(ITasResolver tasResolver) {
		// create EM role
		EmRole emRole = new EmRole.LinuxBuilder(EM_ROLE_ID, tasResolver).nostartEM()
				.nostartWV().build();
