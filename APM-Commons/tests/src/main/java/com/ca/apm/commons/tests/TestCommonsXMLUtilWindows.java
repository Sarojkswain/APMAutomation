...
public class TestCommonsXMLUtilWindows extends TasTestNgTest {

   private static final Logger LOGGER = LoggerFactory.getLogger(TestCommonsXMLUtilWindows.class);
   ...
   // private final String host;
    ...
    public TestCommonsXMLUtilWindows() {
