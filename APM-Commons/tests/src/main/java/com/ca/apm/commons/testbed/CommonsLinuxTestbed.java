 ...
 */
@TestBedDefinition
public class CommonsLinuxTestbed implements ITestbedFactory {

    public static final String EM_MACHINE_ID = "emMachine";
    public static final String EM_ROLE_ID = "emRole";
    public static final String EM_MACHINE_TEMPLATE_ID = TEMPLATE_CO65;
    public static String platform;
    public ITestbedMachine emMachine;
    @Override
    public ITestbed create(ITasResolver tasResolver) {
      //create EM role
        ...
        emMachine = TestBedUtils.createLinuxMachine(EM_MACHINE_ID, EM_MACHINE_TEMPLATE_ID);
