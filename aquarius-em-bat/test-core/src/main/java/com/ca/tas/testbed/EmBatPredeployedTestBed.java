...
import com.ca.tas.role.ControllerDeployFreeRole;
import com.ca.tas.role.DeployFreeRole;
import com.ca.tas.tests.annotations.TestBedDefinition;

/**
 * Testbed class which should configure already predeployed environment (map roles, etc.) to run EM BAT tests on it.
 *  
 * @author sinal04
 */
@TestBedDefinition
public class EmBatPredeployedTestBed implements ITestbedFactory {
	...
	public ITestbed create(ITasResolver tasResolver) {
        ...
        ControllerDeployFreeRole controllerRole = new ControllerDeployFreeRole.Builder("coda-controller")
