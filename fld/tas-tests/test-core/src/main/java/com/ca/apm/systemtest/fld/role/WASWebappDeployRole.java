...
public class WASWebappDeployRole extends AbstractRole {
    ...
    public void deploy(IAutomationAgentClient aaClient) {
        ...
        updateServerFile(aaClient);
    }
    
    private void updateServerFile(IAutomationAgentClient aaClient) {

		FileModifierFlowContext context = null;
		Map<String, String> replacePairs = new HashMap<String, String>();

		replacePairs.put("xmi:id=\"WorkAreaService_1\" enable=\"false\"", "xmi:id=\"WorkAreaService_1\" enable=\"true\"");
		String fileName = appserverDir
				+ "/profiles/AppSrv01/config/cells/"+host+"Node01Cell/nodes/"+host+"Node01/servers/server1/server-pme.xml";
    ...
    private void deployArtifacts(IAutomationAgentClient aaClient) {
        ...
        context = new GenericFlowContext.Builder()
           .artifactUrl(tasResolver.getArtifactUrl(new DefaultArtifact("com.ca.apm.binaries.was", 
               "was_po_deployment_scripts", "", "zip", "1.0")))
        ...
        context = new GenericFlowContext.Builder()    
            ...
            .artifactUrl(tasResolver.getArtifactUrl(new DefaultArtifact("com.ca.apm.coda-projects.test-tools", 
                "qatestapp", "jvm7-genericnodb", "ear", tasResolver.getDefaultVersion())))
