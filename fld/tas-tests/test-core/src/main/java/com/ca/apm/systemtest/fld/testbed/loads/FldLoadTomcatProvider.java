 ...
 *
 */
public class FldLoadTomcatProvider implements FldTestbedProvider, FLDConstants, FLDLoadConstants {
...
//        tomcat9080Role.before(tomcat9081Role);
    ...
    private TomcatRole configureTomcat9081(ITasResolver tasResolver, ITestbedMachine machine) {
        ...
        machine.addRole(javaRole, axis2Role, wurlitzerRole, tomcat9081Role, tomcatAgentRole);
    ...
    private TomcatRole configureTomcat9080(ITasResolver tasResolver, ITestbedMachine machine) {
        ...
        machine.addRole(javaRole, axis2Role, wurlitzerRole, tomcat9080Role, tomcatAgentRole);
...
//        tomcat7Role.after(tomcat6Role);
        ...
        machine.addRole(javaRole, tomcat7Role, axis2Role, qaTestAppRole, tomcatAgentRole, helloWorldRole);
    ...
    private TomcatRole configureTomcat6(ITasResolver tasResolver, ITestbedMachine machine) {
        ...
        machine.addRole(javaRole, axis2Role, qaTestAppRole, tomcat6Role, tomcatAgentRole, tessTestRole);
