package com.ca.apm.systemtest.fld.util.memorymonitor;
...
public class MemoryMonitorRunner {
    ...
    public static void main(String[] args) {
        ...
        try {
                ...
                for (int i = 0; i < iterationCount; i++) {
                    ...
                    try {
                        ...
                        ErrorUtils.logExceptionFmt(LOGGER, e,
                            "MemoryMonitorRunner.createChart():: cannot create GC chart: {0}");
                    }
            ...
            // infinite loop mode
                ...
                while (true) {
                    ...
                    try {
                        ...
                        ErrorUtils.logExceptionFmt(LOGGER, e,
                            "MemoryMonitorRunner.main():: cannot create GC chart: {0}");
                    }
            ...
            throw ErrorUtils.logExceptionAndWrap(LOGGER, e,
                "MemoryMonitorRunner.main():: exception occurred: {0}");
        } finally {
    ...
    public void createChart() {
        try {
            ...
            uploadFile(new ByteArrayInputStream(out.toByteArray()), gcSummaryFile);
            LOGGER.info("Uploaded OK");
        } catch (Exception e) {
            ErrorUtils.logExceptionAndWrap(LOGGER, e,
                "MemoryMonitorRunner.createChart():: exception during creating GC chart: {0}");
        }
    ...
    private ByteArrayOutputStream readGcLog(String gcLogFile, File gcSummaryFile) {
        ...
        try (DataWriter summaryWriter =
            ...
            ErrorUtils.logExceptionAndWrap(LOGGER, e,
                "MemoryMonitorRunner.readGcLog():: exception during processing GC logfiles: {0}");
        }
        return out;
    }
    ...
    private static MemoryMonitorRunner init(Namespace namespace) {
        ...
        return new MemoryMonitorRunner(gcLogFile, group, roleName, memoryMonitorWebappHost, memoryMonitorWebappPort,
            memoryMonitorWebappContextRoot, chartWidth, chartHeight);
    }

    public MemoryMonitorRunner(String gcLogFile, String group, String roleName, String memoryMonitorWebappHost,
