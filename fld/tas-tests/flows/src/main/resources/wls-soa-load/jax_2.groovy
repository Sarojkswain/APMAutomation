...
public class JaxWSClientRequests extends BaseSystemTest {
	...
	@Test
	public void service2_operations_1_to_5() throws Exception {

		log.info("WURLITZER Service1 WSDL =  " + webServiceHost2Service1URL.toString())
		...
		ws1.setExecutionLocation(webServiceHost2Service1URL)
		ws1.setOperationStart(6)
		ws1.setOperationEnd(9)
	...
	@Test
	public void service21_and_service2_operations() throws Exception  {
		...
		JaxWebService1 ws1 = new JaxWebService1()
		ws1.setExecutionLocation(webServiceHost2Service1URL)
		ws1.setOperationStart(2)
		ws1.setOperationEnd(3)
		transaction.addCommand(ws1)

		// Each operation should then call operation10 ... operation12)
		JaxWebService1 ws2 = new JaxWebService1()
		ws2.setExecutionLocation(webServiceHost2Service1URL)
		ws2.setOperationStart(13)
		ws2.setOperationEnd(15)
		...
		ws3.setExecutionLocation(webServiceHost2Service2URL)
		ws3.setOperationStart(51)
		ws3.setOperationEnd(56)
