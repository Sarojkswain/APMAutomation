...
public class ConsoleTransferListener
    ...
    private Logger out = LoggerFactory.getLogger("maven.transfer");

    private Map<TransferResource, Long> downloads = new ConcurrentHashMap<>(10);
    ...
    public void transferInitiated(TransferEvent event) {
        ...
        out.info("{}: {}{}", message, event.getResource().getRepositoryUrl(), event.getResource()
            .getResourceName());
    }
    ...
    protected static long toKB(long bytes) {
