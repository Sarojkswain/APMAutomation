...
/**
 * <code>Msie64BitBrowser</code> instantiates the Selenium IEDriver (64-bit),
    ...
    extends Browser
{
     ...
     * @since QATF2.0
     */
    public Msie64BitBrowser(Properties prop)
    {
        super(prop);
    ...
    {
        return getProperty("ie64.driver.executable.path");
    }
