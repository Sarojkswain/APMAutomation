...
public class IntroscopeCommonArtifact implements ITasArtifactFactory {

    // <dependency>
    // <groupId>com.ca.apm.common</groupId>
    // <artifactId>com.wily.introscope.common</artifactId>
    // <version>${project.version}</version>
    // </dependency>

    private static final String GROUP_ID = "com.ca.apm.common";
    private static final String ARTIFACT_ID = "com.wily.introscope.common";
