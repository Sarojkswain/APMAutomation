...
public class LibArtifact implements ITasArtifactFactory {

    private static final String GROUP_ID = "com.ca.apm.coda.qatestng";
    private static final String ARTIFACT_ID = "lib";
