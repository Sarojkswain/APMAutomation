...
public class The100_TSDMetricsArtifact implements ITasArtifactFactory {

    // <dependency>
    // <groupId>com.ca.apm.coda.HVRAgent</groupId>
    // <artifactId>100_TSD</artifactId>
    // <version>1.0</version>
    // <type>zip</type>
    // </dependency>


    private static final String GROUP_ID = "com.ca.apm.coda.HVRAgent";
    private static final String ARTIFACT_ID = "100_TSD";
    private static final IBuiltArtifact.TasExtension EXTENSION = IBuiltArtifact.TasExtension.ZIP;
    private static final String VERSION = "1.0";


    public The100_TSDMetricsArtifact() {
    }
