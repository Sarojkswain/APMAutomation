...
public class FrameworkArtifact implements ITasArtifactFactory {

    private static final String GROUP_ID = "com.ca.apm.coda-projects.test-projects";
    private static final String ARTIFACT_ID = "com.ca.apm.webui.test.framework";
    ...
    public FrameworkArtifact(ITasResolver resolver) {
