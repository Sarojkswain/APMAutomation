...
public final class ErrorReport {
    ...
    public static NoSuchElementException elementNotFound(Logger log, NoSuchElementException ex,
        WebViewUi ui, String fmt, Object... params) {
        final String msg = logExceptionFmt(log, ex, fmt, params);
        log.error(msg, ex);
        ui.takeScreenShot();
        return new NoSuchElementException(msg, ex);
    }
}
