...
public class FunctionalTestArtifact implements ITasArtifactFactory {

    private static final String GROUP_ID = "com.ca.apm.coda-projects.test-projects";
    private static final String ARTIFACT_ID =
        "com.ca.apm.introscope.workstation.webapp.functionaltests";
    ...
    public FunctionalTestArtifact(ITasResolver resolver) {
