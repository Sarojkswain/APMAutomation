 ...
 * with variables set for windows version.
 *
 */
@TestBedDefinition
public class OneMomOneCollectorThreeAgentsWindowsTestbed
    extends OneMomOneCollectorThreeAgentsAbstractTestbed implements ITestbedFactory {

    public OneMomOneCollectorThreeAgentsWindowsTestbed() {
        super();
        TESTBED_NAME = "OneMomOneCollectorThreeAgentsWindowsTestbed";
