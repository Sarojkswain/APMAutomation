 ...
 */
@TestBedDefinition
public class OneMomTwoCollectorsLinuxTestbed extends OneMomTwoCollectorsAbstractTestbed
    implements
        ITestbedFactory {

    public OneMomTwoCollectorsLinuxTestbed() {
        super();
        TESTBED_NAME = "OneMomTwoCollectorsLinuxTestbed";
