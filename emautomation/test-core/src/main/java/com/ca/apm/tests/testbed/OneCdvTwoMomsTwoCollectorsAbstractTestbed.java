 ...
 */
@TestBedDefinition
public abstract class OneCdvTwoMomsTwoCollectorsAbstractTestbed implements ITestbedFactory {
    public static final String MOM_1_MACHINE_ID = "mom1Machine";
    public static final String MOM_2_MACHINE_ID = "mom2Machine";
    ...
    public static final String MOM_1_ROLE_ID = "mom1Role";
    public static final String MOM_2_ROLE_ID = "mom2Role";
    ...
    public static final int EM_DEFAULT_PORT = 5001;
    ...
    public ITestbed create(ITasResolver tasResolver) {
        ...
        final EmRole mom1Role = createMomRole(MOM_1_ROLE_ID, collectorRole1);

        // ************************************
        // Cluster B
        // ************************************
        final EmRole collectorRole2 = createCollectorRole(COLLECTOR_2_ROLE_ID);
        final EmRole mom2Role = createMomRole(MOM_2_ROLE_ID, collectorRole2);
        ...
        final TestbedMachine mom1Machine = createMomMachine(MOM_1_MACHINE_ID, mom1Role);
        mom1Machine.addRole(mom1Role);

        final TestbedMachine mom2Machine = createMomMachine(MOM_2_MACHINE_ID, mom2Role);
        mom2Machine.addRole(mom2Role);
    ...
    private EmRole createMomRole(String roleId, EmRole collectorRole) {
    ...
    private IRole createTomcatAgentRole(String roleId, EmRole momRole, TomcatRole tomcatRole) {
        final IRole agentRole =
            BuilderFactories.getAgentBuilder(PLATFORM, roleId, tasResolver).webAppRole(tomcatRole)
                .emRole(momRole).disableWebAppAutoStart().build();
        return agentRole;
    }
