...
@TestBedDefinition
public class DataPowerExtensionUMAAgentLinuxStandaloneTestBed implements ITestbedFactory {
     ...
     public ITestbed create(ITasResolver tasResolver) {
         ...
         GenericRole downloadExtensionFileRole =
             new GenericRole.Builder(DATA_POWER_EXTENSION_ROLE_ID, tasResolver).unpack(
                 new DefaultArtifact("com.ca.apm.coda.testdata.extension", "DataPowerMonitor", "zip", "4.0"), CONFIG_FILES_LOC+"/extensions/DataPower").build();
         ...
         agentMachine.addRole(tomcatRole, downloadExtensionFileRole, qaAppTomcatRole, tomcatAgentRole, downloadUMARole);
