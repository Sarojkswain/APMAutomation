 ...
 */
@TestBedDefinition
public class SpringWebServicesExtensionWindowsStandaloneTestbed implements ITestbedFactory {
    ...
    public ITestbed create(ITasResolver tasResolver) {
        ...
        GenericRole downloadExtensionFileRole =
            new GenericRole.Builder(SPRING_EXTENSION_ROLE_ID, tasResolver).unpack(
                new DefaultArtifact("com.ca.apm.coda.testdata.extension", "SpringWebservices", "zip", "1.0"), CONFIG_FILES_LOC).build();
