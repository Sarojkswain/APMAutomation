    ...
    public void addBT(String btName, String btDescription, int numberOfBTCount)
    {
       ...
       /* public void addAllURLSubComponents(String urlHost)
        ...
        public void addalldataonCemUi()
        {
            ...
            addAllTransaction();
            addAllComponents();
            addAllPathSubComponents("/examplesWebApp", "/index.jsp",1);
            addAllPathSubComponents("/examples/servlets", "/servlet/HelloWorldExample",2);
            enableAllBS();
            syncronizeMonitors();
        }
