...
public class SeleniumDetails {
    ...
    private SeleniumDetails(Builder builder) {
        ...
        this.seleniumUrl = builder.seleniumUrl;
    ...
    public static class Builder {
        ...
        public SeleniumDetails build() {
            ...
            Args.notNull(this.seleniumUrl, "SELENIUM URL IS REQUIRED");
            return new SeleniumDetails(this);
        }

        public Builder browser(String browser) {
            this.browser = browser;
            LOGGER.info("SELENIUM DETAILS BUILDER ---- BROWSER IN USE IS : " + browser);

            LoggingPreferences logPrefs = new LoggingPreferences();
            logPrefs.enable(LogType.BROWSER, Level.ALL);

            if (browser.contains("Chrome")) {
                // TODO: Take action if file is not deleted? If yes, add - if-else block
                ...
                this.browserCapability.setCapability(ChromeOptions.CAPABILITY, chromeOptions);
        ...
        public Builder seleniumUrl(String seleniumUrl) {
            this.seleniumUrl = seleniumUrl;
            return this;
        }
    }
