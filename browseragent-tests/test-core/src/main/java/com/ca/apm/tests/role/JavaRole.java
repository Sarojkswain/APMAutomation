...
public class JavaRole extends AbstractRole {
    ...
    public void deploy(IAutomationAgentClient aaClient) {
        aaClient.runJavaFlow(new FlowConfigBuilder(DeployJavaFlow.class, javaFlowContext,
     ...
     * {@link com.ca.tas.role.webapp.JavaRole}
     */
    ...
    public static class Builder extends BuilderBase<Builder, JavaRole> {
        ...
        public JavaRole build() {
            ...
            URL artifactUrl =
                tasResolver.getArtifactUrl(javaArtifact == null
                    ? javaBinary.getArtifact()
                    : javaArtifact);
        ...
        protected void initJdkExecPath() {
            ...
            execPath =
                javaFlowContext.getInstallDir() + getPathSeparator() + "bin" + getPathSeparator()
                    + getJavaBinary();
        }
        ...
        protected void initJreExecPath() {
            ...
            execPath =
                javaFlowContext.getInstallDir() + getPathSeparator() + "jre" + getPathSeparator()
                    + "bin" + getPathSeparator() + getJavaBinary();
        }
        ...
        public Builder version(@NotNull IThirdPartyArtifact javaArtifact,
    ...
    public String toString() {
        return "JavaRole{" + "javaRuntime=" + javaRuntime + ", javaFlowContext=" + javaFlowContext
            + '}';
    }
}
