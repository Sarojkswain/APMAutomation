 ...
 */
@TestBedDefinition
public class DevStandAloneTestBed implements ITestbedFactory {
    ...
    public static final String CPU_APP_LOCATION = "C:\\SW\\LoadGenerator";
    ...
    public static final String VERSION = "99.99.aries_javaagent-SNAPSHOT";//10.5.0-SNAPSHOT
            ...
            new EmRole.Builder(SA_MASTER_EM_ROLE, tasResolver)
              ...
              //  .version(VERSION)
                ...
                .configProperty(
                    ...
                    "120").configProperty("introscope.triage.uvb.relay.interval", "60000")
                ...
                .configProperty("introscope.apm.appmap.vertexCleaner.networkAttributePropagation", "true")
                .build();
    ...
    private IRole addTestAppDeploymentRoles(String prefix, ITasResolver tasResolver,
        ...
        IRole startNormalLoadRole =
            startNormalLoadRole(TOMCAT_INSTALL_DIR + "\\webapps\\pipeorgan\\WEB-INF\\lib\\",
                tasResolver, prefix + "-startNormalLoadRole");
        ...
        // add only roles created here //startNormalLoadRole,
        machine.addRole( pipeScriptsRole, createH2SchemaRole,
            startH2ServerRole, copyH2SchemaFileRole, h2Role, agentRole, tomcatRole,cpuAppDeployRole,startNormalLoadRole);
    ...
    private IRole getAgentRole(String roleId, ITasResolver tasResolver, AgentCapable tomcatRole,
    	...
    	agentProperties.put("introscope.agent.urlgroup.frontend.url.clamp", "300");
        return (new AgentRole.Builder(roleId, tasResolver))
            .intrumentationLevel(AgentInstrumentationLevel.FULL).webAppServer(tomcatRole).additionalProperties(agentProperties)
            .emRole(emRole)/*.version(VERSION)*/.webAppAutoStart().build();
    }
    ...
    private IRole startNormalLoadRole(String location, ITasResolver tasResolver, String roleName) {
        String command =
            "start /d " + location + " " + BAT_FILE + " \"" + location
                + "*\" ./scenarios/NormalScenario.xml";
    ...
    private IRole deployCPURole(String cpuAppLocation, ITasResolver tasResolver, String roleName) {
        ...
        String deployLocation = cpuAppLocation + "\\cpuLoadApp.jar";
        GenericRole cpuRole =
            new GenericRole.Builder(roleName, tasResolver).download(loadJar, deployLocation).build();
