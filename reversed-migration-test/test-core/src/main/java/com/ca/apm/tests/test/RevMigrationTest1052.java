...
/**
 * Reversed Migration from 10.5.2
 */
public class RevMigrationTest1052 extends RevMigrationTestBase {
    public static final String TEST_GROUP_REVMIG_LOCAL = "revmig_1052";
    ...
    @Tas(testBeds = {@TestBed(name = RevMigrationTestBed.class, executeOn = RevMigrationTestBed.STANDALONE_MACHINE,
            params = {
                    ...
                    @TestBedParameter(name = RevMigrationTestBed.PARAM_APM_VERSION, value = RevMigrationTestBed.APM_10_5_2),
    ...
    public void testReversedMigration1052PostgresCO66() throws Exception {
        test(false);
    }
    ...
    @Test(groups = { TEST_GROUP_REVMIG, TEST_GROUP_REVMIG_LOCAL})
    public void testReversedMigration1052PostgresCO7() throws Exception {
        test(false);
    }
    ...
    @Test(groups = { TEST_GROUP_REVMIG, TEST_GROUP_REVMIG_LOCAL})
    public void testReversedMigration1052PostgresW64() throws Exception {
        test(false);
    }
    ...
    @Test(groups = { TEST_GROUP_REVMIG, TEST_GROUP_REVMIG_LOCAL})
    public void testReversedMigration1052OracleCO66() throws Exception {
        test(false);
    }
    ...
    @Test(groups = { TEST_GROUP_REVMIG, TEST_GROUP_REVMIG_LOCAL})
    public void testReversedMigration1052OracleCO7() throws Exception {
        test(false);
    }
    ...
    @Test(groups = { TEST_GROUP_REVMIG, TEST_GROUP_REVMIG_LOCAL})
    public void testReversedMigration1052OracleW64() throws Exception {
        test(false);
    }
}
