 ...
 * @author jirji01
 */
public class BigDataUpgradeTest extends TasTestNgTest {

    private final Logger log = Logger.getLogger(getClass());

    @Test(groups = {"upgrade_big"})
    @Tas(testBeds = @TestBed(name = BigDataUpgradeTestbed.class, executeOn = BigDataUpgradeTestbed.MOM_MACHINE_ID), size = SizeType.GIGANTIC, owner = "jirji01")
