...
@TestBedDefinition
public class StandAloneWithNowhereBankBTTestBed implements ITestbedFactory {
    ...
    public ITestbed create(ITasResolver tasResolver) {
        ...
        /* -- Initialize machines -- */
        ITestbedMachine emMachine = new TestbedMachine.LinuxBuilder(MACHINE_ID)
        ...
        NowhereBankBTRole nowhereBankBTRole = new NowhereBankBTRole
            .LinuxBuilder(NWB_ROLE_ID,tasResolver)
