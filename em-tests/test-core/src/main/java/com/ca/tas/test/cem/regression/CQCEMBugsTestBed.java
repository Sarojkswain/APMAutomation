 ...
 */
package com.ca.tas.test.cem.regression;
 ...
 */
@TestBedDefinition
public class CQCEMBugsTestBed implements ITestbedFactory {

    @Override
    public ITestbed create(ITasResolver tasResolver) {
        ITestbed testbed = new Testbed("cq/automation/bugs/bugs_cem.xml");
        // setup controller
        ...
        controllerMachine.addRole(new DeployFreeRole("clientdb"));
        controllerMachine.addRole(new DeployFreeRole("em01"));
        controllerMachine.addRole(new DeployFreeRole("client06"));
        controllerMachine.addRole(new DeployFreeRole("client05"));
        controllerMachine.addRole(new DeployFreeRole("client03"));
        controllerMachine.addRole(new DeployFreeRole("client04"));
        controllerMachine.addRole(new DeployFreeRole("clientresults"));
        controllerMachine.addRole(new DeployFreeRole("client01"));
        controllerMachine.addRole(new DeployFreeRole("client02"));
        ...
        cl1TestingMachine.addRole(new DeployFreeRole("em02"));
        ...
        cl2TestingMachine.addRole(new DeployFreeRole("agent03"));
        cl2TestingMachine.addRole(new DeployFreeRole("agent04"));
        cl2TestingMachine.addRole(new DeployFreeRole("client07"));
