 ...
 */
package com.ca.tas.test.em.sm.smoke;
...
/**
 * Represents testbed driven by CODA controller which consists of following machines to reflect the intention of
 * customer to install CA Introscope in various roles.
 *
...
public class SupportabilityMetricsSmokeTestBed implements ITestbedFactory {
    ...
    public ITestbed create(ITasResolver tasResolver) {
        ITestbed testbed =
            new Testbed(
                "qa/EM/92/SupportabilityMetrics/suite/sm_testsuite_smoke_with_onerror.xml");
        // setup controller
