...
public class DeployManagementModuleFlow extends FlowBase {
     ...
     * @throws Exception
     */
    static public void exportResource(String resourcePathName, File outFolder) throws Exception {
        ...
        try {
            ...
            if (stream == null) {
                throw new Exception("Cannot get resource \"" + resourcePathName + "\" from Jar file.");
            }
