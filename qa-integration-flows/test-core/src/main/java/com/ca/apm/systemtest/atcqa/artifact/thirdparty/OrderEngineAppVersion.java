 ...
 */
public enum OrderEngineAppVersion implements IThirdPartyArtifact {

    v_10_5_2_4("10.5.2.4"), v_99_99_aquarius("99.99.aquarius-SNAPSHOT");

    private static final String GROUP_ID = "com.ca.apm.testing";
    private static final String ARTIFACT_ID = "OrderEngine";
     ...
     */
    private OrderEngineAppVersion(String version) {
