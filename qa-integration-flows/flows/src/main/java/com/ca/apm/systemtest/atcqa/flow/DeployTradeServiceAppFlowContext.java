...
public class DeployTradeServiceAppFlowContext implements IFlowContext {
    ...
    private final URL reportingServiceAppArtifactURL;
    private final URL orderEngineAppArtifactURL;
    /**
    ...
    public DeployTradeServiceAppFlowContext(Builder builder) {
        ...
        reportingServiceAppArtifactURL = builder.reportingServiceAppArtifactURL;
        orderEngineAppArtifactURL = builder.orderEngineAppArtifactURL;
    ...
    public URL getReportingServiceAppArtifactURL() {
        return reportingServiceAppArtifactURL;
    }

    public URL getOrderEngineAppArtifactURL() {
        return orderEngineAppArtifactURL;
    }
    ...
    public static class Builder implements IBuilder<DeployTradeServiceAppFlowContext> {
        ...
        @NotNull
        private URL reportingServiceAppArtifactURL;
        @NotNull
        private URL orderEngineAppArtifactURL;
        ...
        public Builder reportingServiceAppArtifactURL(@NotNull URL reportingServiceAppArtifactURL) {
            this.reportingServiceAppArtifactURL = reportingServiceAppArtifactURL;
            return this;
        }

        public Builder orderEngineAppArtifactURL(@NotNull URL orderEngineAppArtifactURL) {
            this.orderEngineAppArtifactURL = orderEngineAppArtifactURL;
            return this;
        }
