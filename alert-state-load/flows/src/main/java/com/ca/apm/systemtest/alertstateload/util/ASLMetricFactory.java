...
public class ASLMetricFactory extends DefaultMetricDataFactory
    implements
        MetricFactory,
        MetricConstants {
...
//    private static int nextId = 10000;
    ...
    public ASLMetricFactory(String domain, String hostname, String processName, String agentName, String warBaseName, int numWars, /* String ejbBaseName, int numEjbs, List<WebFrontend> webFrontends */
                            int minValueAverageResponseTime, int maxValueAverageResponseTime) {
...
//    }
    ...
    /*
     * tomcat01.*\|.*
     * Frontends\|Apps\|tesstest:Average Response Time \(ms\)
     * 
     */
    private void setupFrontendMetricGroup() {
        ...
        for (String warName : warNames) {
            ...
            new IntAverageMetricDefinition(prefix, AVG_RESP_TIME, defaultUrlMetricGroup, minValueAverageResponseTime/*200*/, maxValueAverageResponseTime/*300*/);
