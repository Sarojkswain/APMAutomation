...
public class WurlitzerMmArtifact implements ITasArtifactFactory {

    private static final String GROUP_ID = "com.ca.apm.coda.EM.managementmodule";
    private static final String ARTIFACT_ID = "WurlitzerMM";
    private static final String VERSION = "20141205";
