 ...
 * Test description
 */
public class AgentPerformanceRegression104FullTest extends AgentPerformanceRegression104Test {

    public AgentPerformanceRegression104FullTest() throws Exception {
    }
