 ...
 */
@TestBedDefinition
public class AgentPerformanceRegression103UndeployTestBed extends AgentPerformanceRegression103TestBed {

    public static final boolean UNDEPLOY_TOMCAT = true;
    public static final boolean UNDEPLOY_WAS = true;
    public static final boolean UNDEPLOY_WLS = true;
    public static final boolean UNDEPLOY_IIS = true;
...
//        testBed.addMachine(emMachine);
        ...
        if (UNDEPLOY_TOMCAT) {
            ...
            // AS TOMCAT
            ITestbedMachine appServerTomcatMachine = (new AppServerTomcatMachine(AS_TOMCAT_MACHINE_ID, tasResolver, AGENT_CURRENT_VERSION, AGENT_PREV_VERSION, DEFAULT_COPY_RESULTS_PASSWORD))
                    .undeploy();
        ...
        if (UNDEPLOY_WAS) {
            ...
            // AS WEBSPHERE
            ITestbedMachine appServerWasMachine = (new AppServerWebsphereMachine(AS_WAS_MACHINE_ID, tasResolver, AGENT_CURRENT_VERSION, AGENT_PREV_VERSION, DEFAULT_COPY_RESULTS_PASSWORD))
                    .undeploy();
        ...
        if (UNDEPLOY_WLS) {
            ...
            // AS WEBLOGIC
            ITestbedMachine appServerWlsMachine = (new AppServerWeblogicMachine(AS_WLS_MACHINE_ID, tasResolver, AGENT_CURRENT_VERSION, AGENT_PREV_VERSION, DEFAULT_COPY_RESULTS_PASSWORD))
                    .undeploy();
        ...
        if (UNDEPLOY_IIS) {
            ...
            // AS IIS
            ITestbedMachine appServerIisMachine = (new AppServerIisMachine(AS_IIS_MACHINE_ID, tasResolver, AGENT_CURRENT_VERSION, AGENT_PREV_VERSION, DEFAULT_COPY_RESULTS_PASSWORD))
                    .undeploy();
