 ...
 */
public class CsvToXlsVersion implements ITasArtifactFactory {
    private static final String GROUP_ID = "com.ca.apm.coda-projects.test-tools";
    private static final String ARTIFACT_ID = "csvtoxls";
    ...
    public CsvToXlsVersion(ITasResolver resolver) {
