 ...
 */
public class JmxMonitorVersion implements ITasArtifactFactory {
    private static final String GROUP_ID = "com.ca.apm.coda-projects.test-tools";
    private static final String ARTIFACT_ID = "jmxmonitor";
    ...
    public JmxMonitorVersion(ITasResolver resolver) {
