...
public enum JMeterVersion implements IThirdPartyArtifact {
    ...
    VER_2_11("apache-jmeter-2.11", TasExtension.ZIP, "apache-jmeter-2.11", "com/ca/apm/coda/jmeter");
     ...
     */
    JMeterVersion(String archiveFileName, TasExtension extension, String unpackDir, String groupId) {
