...
/**
 * StockTrader and Trade6 DB Script for creating necessary tables in Oracle DB
 *
 * @author Erik Melecky (meler02@ca.com)
 */
public enum StocktraderTradeDbScriptVersion implements IThirdPartyArtifact {

    VER_55("stocktrader_trade6_tradedb_dbscript", TasExtension.ZIP, "stocktrader_trade6_tradedb_dbscript.sql");
     ...
     */
    StocktraderTradeDbScriptVersion(String archiveFileName, TasExtension extension, String sqlFileName) {
