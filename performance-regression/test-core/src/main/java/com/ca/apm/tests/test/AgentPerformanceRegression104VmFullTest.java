 ...
 * Test description
 */
public class AgentPerformanceRegression104VmFullTest extends AgentPerformanceRegression104Test {

    public AgentPerformanceRegression104VmFullTest() throws Exception {
    }
