...
@TestBedDefinition
public class G1TestBedCleaner implements TestBedCleanerFactory<G1TestBed> {

    @Override
    public ITestbed create(final ITasResolver tasResolver,
                           final G1TestBed javaTestBedFactory) {
        ITestbed deployedTestBed = javaTestBedFactory.create(tasResolver);
        Testbed testBed = new Testbed(G1TestBedCleaner.class.getSimpleName());

        testBed.addMachine(cleanApm(deployedTestBed, G1TestBed.EM_ROLE_ID, G1TestBed.EM_MACHINE_ID));
