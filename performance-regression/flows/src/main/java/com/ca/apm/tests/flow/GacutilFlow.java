 ...
 */
@Flow
public class GacutilFlow extends FlowBase {

    public static final String DEFAULT_EXECUTABLE = "gacutil.exe";

    private static final Logger LOGGER = LoggerFactory.getLogger(GacutilFlow.class);
    @FlowContext
    private GacutilFlowContext context;
