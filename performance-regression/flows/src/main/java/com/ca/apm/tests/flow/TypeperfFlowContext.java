 ...
 */
public class TypeperfFlowContext implements IFlowContext, EnvPropSerializable<TypeperfFlowContext>, INetShareUser {
    ...
    public static class Builder extends ExtendedBuilderBase<TypeperfFlowContext.Builder, TypeperfFlowContext> {
