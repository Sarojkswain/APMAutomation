...
public class TypeperfFlowContextSerializer extends MyEnvPropertySerializerAbs<TypeperfFlowContext> {
    private static final Logger LOGGER = LoggerFactory.getLogger(TypeperfFlowContextSerializer.class);
    ...
    public TypeperfFlowContext deserialize(String key, Map<String, String> serializedData) {
        ...
        if (metrics == null) {
            throw new IllegalArgumentException("Insufficient arguments in env property file: metrics is missing.");
        }
        if (runTime == null) {
        ...
        if (outputFileName == null) {
            ...
            TypeperfFlowContext.Builder builder = new TypeperfFlowContext.Builder()
                    .metrics(metrics)
                    .runTime(runTime)
