 ...
 */
public class QcUploadToolDeployFlowContext implements IFlowContext {

    private final URL deployPackageUrl;
    private final String deploySourcesLocation;


    protected QcUploadToolDeployFlowContext(QcUploadToolDeployFlowContext.Builder builder) {
    ...
    public static class Builder extends ExtendedBuilderBase<QcUploadToolDeployFlowContext.Builder, QcUploadToolDeployFlowContext> {
        ...
        public QcUploadToolDeployFlowContext build() {
            QcUploadToolDeployFlowContext context = this.getInstance();
        ...
        protected QcUploadToolDeployFlowContext getInstance() {
            return new QcUploadToolDeployFlowContext(this);
        }

        public QcUploadToolDeployFlowContext.Builder deployPackageUrl(URL deployPackageUrl) {
            this.deployPackageUrl = deployPackageUrl;
            return this.builder();
        }

        public QcUploadToolDeployFlowContext.Builder deploySourcesLocation(String deploySourcesLocation) {
            this.deploySourcesLocation = deploySourcesLocation;
            return this.builder();
        }

        protected QcUploadToolDeployFlowContext.Builder builder() {
            return this;
        }
    }
}