 ...
 * 
 * Author : KATRA03/ Raghu Chandra Katikeri
 * Date : 13/15/2016
 */
...
import com.ca.apm.tests.utils.ApmSqlSeverArtifact;
 ...
 * in Windows for execution of all Sql Server test cases. *
 */

@TestBedDefinition
public class ApmSqlServerWindowsClusterTestbed implements ITestbedFactory {
    ...
    public static String KEY_EM_INSTALL_DIR;

    public static final String APM_SQL_SERVER_ROLE_ID = "apmSqlServerRole";
    ...
    protected Artifact apmSqlArtifact;
