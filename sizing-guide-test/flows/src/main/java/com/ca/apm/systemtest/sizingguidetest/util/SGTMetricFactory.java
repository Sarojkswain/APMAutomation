...
public class SGTMetricFactory extends DefaultMetricDataFactory
    implements
        MetricFactory,
        MetricConstants {
    ...
    public SGTMetricFactory(String domain, String hostname, String processName, String agentName,
        String warBaseName, int numWars, String ejbBaseName, int numEjbs,
        List<WebFrontend> webFrontends, int minValueAverageResponseTime,
    ...
    private void setupFrontendMetricGroup() {
        ...
        for (String warName : warNames) {
            ...
            new IntAverageMetricDefinition(prefix, AVG_RESP_TIME, defaultUrlMetricGroup,
                minValueAverageResponseTime/* 200 */, maxValueAverageResponseTime/* 300 */);
            addBasicFive(defaultUrlMetricGroup);

            MetricGroup calledBackendsMG =
                new MetricGroup("Called Backends", defaultUrlMetricGroup);
            MetricGroup ws1MetricGroup =
                new MetricGroup("WebService at http_//tas-czfld-n25_8080", calledBackendsMG);
    ...
    private void addBasicFive(MetricGroup mg) {
        new IntAverageMetricDefinition(prefix, AVG_RESP_TIME, mg, 200, 300);
